            ...
            <div key={val.time} className={`${val.isSentByMe ? "end" : ""} msg`}>
                ...
                {val['type'] === 'file' &&
                    <div className={'file msg'} >
                        {(val.message.endsWith('.webm') || val.message.endsWith('.mp3'))  && <VoicePlayer audioSrc={val}/>}
